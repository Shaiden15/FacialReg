...
# Use production config on Railway, development locally
config_name = 'production' if os.environ.get('RAILWAY_ENVIRONMENT') or os.environ.get('RAILWAY_ENV') else 'development'
